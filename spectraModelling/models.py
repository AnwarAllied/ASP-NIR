...
# from spectraModelling.models import Poly, Match, poly_for_all, to_wavelength_length_norm, wavelength_length, poly_update_similar_all
# from spectraModelling.models import poly_for_all as pa
# from core.models import Spectrum
# po=Poly(spectrum = Spectrum.objects.get(pk=2))
# po.obtain()
# def norm(t):
#     y=to_wavelength_length(t)
#     mx=max(y)
#     mi=min(y)
