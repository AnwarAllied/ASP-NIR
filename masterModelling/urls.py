...
urlpatterns = [
    ...
    # path('master_pca/<int:id>/<slug:stat>', master_pca.as_view(), name='master_pca_chart'),
    path('master_pca_element/', master_pca_element.as_view(), name='master_pca_element'),
    path('master_pca_element_chart/', master_pca_element_chart.as_view(), name='master_pca_element_chart'),
